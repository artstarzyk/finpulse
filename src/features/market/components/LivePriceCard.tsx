...
export function LivePriceCard() {
  ...
  const { symbol, lastPrice, bid, ask, lastUpdate, status } = useMarketStore();
    ...
    >
      ...
      <div className="flex flex-col gap-1">
        ...
        {hasData ? (
          ...
          <span className="text-4xl font-bold text-zinc-600 tabular-nums">
            $—
          </span>
        )}
      </div>
      ...
      {/* Last update */}
      <p className="text-xs text-zinc-600 text-right" data-testid="last-update">
